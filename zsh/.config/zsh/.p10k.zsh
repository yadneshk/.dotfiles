# Generated by Powerlevel10k configuration wizard on 2025-08-18 at 18:17 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#ed8796'
  # Custom icon.
  ...
  # Custom icon.
  # typeset -g POWERLEVEL9K_GOENV_VISUAL_IDENTIFIER_EXPANSION='󰟓'
  ...
  #######################[ go_version: go version (https://golang.org) ]########################
  # Go version color.
  typeset -g POWERLEVEL9K_GO_VERSION_BACKGROUND="#808080"
  typeset -g POWERLEVEL9K_GO_VERSION_FOREGROUND="#00FFFF"
  #typeset -g POWERLEVEL9K_GO_VERSION_FOREGROUND="#86D4DE"
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|cmctl|sparkctl|oc'
